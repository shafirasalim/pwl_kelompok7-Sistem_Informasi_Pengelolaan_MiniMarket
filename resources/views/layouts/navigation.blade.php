        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Menu Produk - Owner, Manager, Supervisor, Warehouse --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-4">
                <!-- Dark Mode Toggle -->
                <button onclick="toggleDarkMode()" class="inline-flex items-center p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition ease-in-out duration-150">
                    <!-- Sun Icon (shown in dark mode) -->
                    <svg id="sun-icon" class="hidden h-5 w-5 dark:block" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 2a1 1 0 011 1v2a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.536l1.414 1.414a1 1 0 001.414-1.414l-1.414-1.414a1 1 0 00-1.414 1.414zm2.121-10.121l1.414-1.414a1 1 0 00-1.414-1.414l-1.414 1.414a1 1 0 001.414 1.414zM5.464 5.464l1.414-1.414a1 1 0 00-1.414-1.414L4.05 4.05a1 1 0 001.414 1.414zm0 9.072l-1.414 1.414a1 1 0 001.414 1.414l1.414-1.414a1 1 0 00-1.414-1.414zM3 11a1 1 0 110-2 1 1 0 010 2z" clip-rule="evenodd" />
                    </svg>
                    <!-- Moon Icon (shown in light mode) -->
                    <svg id="moon-icon" class="h-5 w-5 dark:hidden" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                ...
                <button onclick="toggleDarkMode()" class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                    {{ __('Toggle Dark Mode') }}
                </button>
